...
const SecondBanner = (props) => {
  ...
  return (
        ...
        <Container  alignBox="row" className={commonStyle.secondBoxWrapper}>
          ...
          <Box className={commonStyle.secondBox}>
...
SecondBanner.defaultProps = {
  src: "https://cdn.soldfy.com/media/restoreit/homebanner/_/7/_708x651.95_-soldfy-website-home-page-banner.jpg",
  alt: "banner",
  href: "#",
};
